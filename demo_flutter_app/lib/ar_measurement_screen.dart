...
class _ArMeasurementScreenState extends State<ArMeasurementScreen>
  ...
  Future<void> _fetchFloorPlan() async {
    ...
    if (data != null) {
      ...
      if (mounted) setState(() => _isLoadingFloorPlan = false);
    }
  }
  ...
  Future<void> _pickAndUploadFloorPlan() async {
    ...
    if (image != null) {
      setState(() => _isLoadingFloorPlan = true);
      final success = await ApiService.uploadFloorPlan(widget.perfiosId!, File(image.path));
                            ...
                            : _floorPlanUrl != null
                                ...
                                : InkWell(
                                    onTap: () {
                                      ...
                                      _pickAndUploadFloorPlan();
                                    },
                                    child: Center(
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Icon(Icons.add_photo_alternate_outlined, size: 80, color: Colors.blue.withValues(alpha: 0.5)),
